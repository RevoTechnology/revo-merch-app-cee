...
import merchant.mokka.api.response.TariffClientData
...
class MockData(val context: Context) {
    ...
    fun getReportData(dateFrom: String, dateTo: String) = Single.just(
        ReportData(
