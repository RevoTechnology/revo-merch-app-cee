...
package merchant.mokka.utils.decoro.parser;
...
public class UnderscoreDigitSlotsParser implements SlotsParser {
    ...
    private static final char SLOT_STUB = '_';
    ...
    private Slot slotFromChar(final char character) {
    ...
    @NonNull
    private Slot slotFromUnderscoreCharacter() {
