...
public class MaskDescriptor implements Serializable, Parcelable {
    ...
    private MaskDescriptor(Parcel in) {
    ...
    private MaskDescriptor setRawMask(@Nullable String rawMask) {
    ...
    private MaskDescriptor setTerminated(boolean terminated) {
    ...
    private MaskDescriptor setInitialValue(@Nullable String initialValue) {
    ...
    private MaskDescriptor setForbidInputWhenFilled(boolean forbidInputWhenFilled) {
    ...
    private MaskDescriptor setHideHardcodedHead(boolean hideHardcodedHead) {
