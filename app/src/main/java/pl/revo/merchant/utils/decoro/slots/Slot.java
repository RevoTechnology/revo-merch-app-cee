...
package pl.revo.merchant.utils.decoro.slots;
...
public final class Slot implements Serializable, Parcelable {
    ...
    private static final int MASK_INPUT_RULES = 3;
    /**
     * On input slot moves it's current value to the nextSlot
     */
    private static final int RULES_DEFAULT = 0;

    static final int RULES_HARDCODED = RULE_INPUT_MOVES_INPUT | RULE_INPUT_REPLACE;

    private static final int RULE_FORBID_CURSOR_MOVE_LEFT = 1 << 2;
    private static final int RULE_FORBID_CURSOR_MOVE_RIGHT = 1 << 3;
    ...
    public boolean anyInputToTheRight() {
        return value != null && !hardcoded() || nextSlot != null && nextSlot.anyInputToTheRight();
    ...
    private int hardcodedSequenceEndIndex(int fromIndex) {
    ...
    private SlotValidatorSet getValidators() {
        return validators;
    }
    ...
    public boolean equals(Object o) {
        ...
        return rulesFlags == slot.rulesFlags &&
                (value != null ? value.equals(slot.value) : slot.value == null) &&
                (tags != null ? tags.equals(slot.tags) : slot.tags == null) &&
                (validators != null ? validators.equals(slot.validators) :
