...
public class MaskImpl implements Mask {
    ...
    MaskImpl(@NonNull Slot[] slots, boolean terminated) {
    ...
    private MaskImpl(@NonNull MaskImpl mask, boolean terminated) {
        this.terminated = terminated;
    ...
    public boolean hasUserInput() {
        return !slots.isEmpty() && slots.getFirstSlot().anyInputToTheRight();
