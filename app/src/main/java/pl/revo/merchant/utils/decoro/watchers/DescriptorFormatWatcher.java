...
import pl.revo.merchant.utils.decoro.MaskDescriptor;
import pl.revo.merchant.utils.decoro.MaskFactoryImpl;
import pl.revo.merchant.utils.decoro.parser.SlotsParser;
...
public class DescriptorFormatWatcher extends FormatWatcher {
    ...
    private DescriptorFormatWatcher(@Nullable SlotsParser slotsParser, @Nullable MaskDescriptor maskDescriptor) {
        this.slotsParser = slotsParser;
    ...
    private void changeMask(@NonNull final MaskDescriptor maskDescriptor) {
        this.maskDescriptor = maskDescriptor;
