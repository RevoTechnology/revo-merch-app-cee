...
public final class PredefinedSlots {
    ...
    public static final Slot[] EXPIRE_DATE= {
            PredefinedSlots.digit(),
            PredefinedSlots.digit(),
            PredefinedSlots.hardcodedSlot('/').withTags(Slot.TAG_DECORATION),
            PredefinedSlots.digit(),
    ...
    public static final Slot[] ACCOUNT_NUMBER = {
            PredefinedSlots.digit(),
            PredefinedSlots.digit(),
            PredefinedSlots.digit(),
            PredefinedSlots.digit(),
    ...
    public static final Slot[] ACCOUNT_NUMBER_STANDARD = {
            PredefinedSlots.digit(),
            PredefinedSlots.digit(),
            PredefinedSlots.digit(),
            PredefinedSlots.digit(),
    ...
    private static Slot maskableDigit() {
